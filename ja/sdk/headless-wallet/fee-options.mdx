...
- **スポンサー付きコントラクトまたはウォレット**：スマートコントラクトやウォレットがスポンサーされている場合、SDK呼び出し時に手数料オプションの入力が不要です。コントラクトやウォレットのスポンサー方法については[こちら](/solutions/builder/gas-sponsorship.mdx)をご覧ください。
...
ウォレットにトークンを送金するか、Web SDKソリューションの[オンランプ機能](/sdk/web/wallet-sdk/embedded/guides/on-ramp)を利用してください。
