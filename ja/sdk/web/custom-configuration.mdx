...
## 構成の概要
利用可能な構成カスタマイズオプションは以下の通りです。詳細は[こちら](/sdk/web/wallet-sdk/embedded/custom-configuration#available-options)をご覧ください。
