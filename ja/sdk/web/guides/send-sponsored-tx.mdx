...
<Steps>
  <Step title="Web SDKのセットアップ">
    [はじめに](/sdk/web/wallet-sdk/embedded/getting-started)ガイドを完了してください。
  </Step>

  <Step title="ガスタンクのセットアップ（メインネットのみ）">
    メインネットでトランザクションを送信する場合は、ガスタンクの設定が必要です。[Gas Sponsorship](/solutions/builder/gas-sponsorship)のページで、ガスタンクの設定方法をご確認ください。
