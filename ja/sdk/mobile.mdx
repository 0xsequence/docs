...
Sequence Embedded Wallet SDKは、React NativeでSequenceの[Embedded Wallet](/solutions_old/wallets/embedded-wallet/overview)や[Indexer](/api-references/indexer/overview)と完全に連携して利用できます。
