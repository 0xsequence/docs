    ...
    <div className="px-6 py-5">
      ...
      <div>
        ...
        <div className="mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400">
          <p>Ethereumチェーン上でアプリやゲームを構築するための、完全なweb3開発スタックです。ウォレット連携、トランザクション管理、スマートコントラクトとのやり取りが含まれています。</p>
        </div>
      </div>
    </div>
  </a>
  ...
  <a className="card block not-prose font-normal group relative my-2 ring-2 ring-transparent rounded-2xl bg-white dark:bg-background-dark border border-gray-950/10 dark:border-white/10 overflow-hidden w-full cursor-pointer hover:!border-primary dark:hover:!border-primary-light" href="/sdk/web/marketplace-sdk/overview">
    <div className="px-6 py-5">
      ...
      <div>
        ...
        <div className="mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400">
          <p>Marketplace SDK は、私たちのマーケットプレイスをアプリケーションにシームレスに統合できる包括的なツールキットです。NFT（ERC721）とセミファンジブルトークン（ERC1155）に対応しています。</p>
        </div>
      </div>
    </div>
  </a>
...
- Unreal Engineのゲームには[Unreal SDK](/sdk/unreal/overview)をご利用ください。
  バックエンドサービスには[Go SDK](/sdk/go/overview)をご確認ください。
