...
基本的には、[Sequence Builderから簡単にデプロイできる監査済みの一次販売コントラクト](/solutions/builder/contracts/deploy-primary-sales-contract)のご利用をおすすめします。
...
[Sequence Builderで一次販売コントラクトを設定](/solutions/builder/contracts/deploy-primary-sales-contract)した後、その詳細をUnityで取得することもできます。
...
<Tip>これらの取引をスポンサーしたい場合は、一次販売コントラクトと価格通貨コントラクトのアドレスを[Gas Tank](/solutions/builder/gas-sponsorship)に追加するのをお忘れなく！</Tip>