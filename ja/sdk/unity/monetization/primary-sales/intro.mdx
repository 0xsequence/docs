...
一般的には、[Sequence Builderから簡単にデプロイできる監査済みのプライマリーセールコントラクト](/solutions/builder/contracts/deploy-primary-sales-contract)のご利用をおすすめします。
...
[Sequence Builderでプライマリーセールコントラクトを設定](/solutions/builder/contracts/deploy-primary-sales-contract)した後、その情報をUnityで取得したい場合があります。
...
<Tip>これらのトランザクションをスポンサーしたい場合は、プライマリーセールコントラクトや価格通貨コントラクトのアドレスを[Gas Tank](/solutions/builder/gas-sponsorship)に追加するのをお忘れなく！</Tip>