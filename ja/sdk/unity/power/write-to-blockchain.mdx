...
<Info>トランザクションスポンサー機能はDeveloperプラン以上でご利用いただけます。ガススポンサーについて詳しくは[こちらのドキュメント](/solutions/builder/gas-sponsorship)をご覧ください。プロジェクトの課金プランのアップグレード方法については[こちらのガイド](/support/builder/project-settings#update-your-project-subscription-plan)をご参照ください。</Info>
