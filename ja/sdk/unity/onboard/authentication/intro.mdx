# 認証 - はじめに
Embedded Wallet SDKとして、認証は非常に重要です。認証は、ユーザーの認証情報と関連付けてセッション署名用ウォレットを確立することで機能します。Embedded Walletの仕組みについて詳しくは、[Embedded Walletドキュメント](/solutions/wallets/developers/embedded-wallet/overview)をご覧ください。
