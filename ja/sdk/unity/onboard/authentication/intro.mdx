# 認証 - はじめに
Embedded Wallet SDK では認証が非常に重要です。認証は、ユーザー認証情報と関連付けてセッション署名用ウォレットを確立することで機能します。Embedded Wallet の仕組みについては、[Embedded Wallet ドキュメント](/solutions/wallets/developers/embedded-wallet/overview) をご覧ください。
