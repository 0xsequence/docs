...
[なぜスマートコントラクトウォレットなのかはこちら](/solutions/technical-references/smart-contract-wallets)をご覧ください。
...
Sequence Embedded Walletソリューションでの認証の仕組みについては、[ドキュメント](/solutions/wallets/developers/embedded-wallet/overview)や[ブログ記事](https://sequence.xyz/blog/sequence-embedded-wallets)をご参照ください。
