...
[なぜスマートコントラクトウォレットなのかはこちら](/solutions_old/technical-references/wallet-contracts/why)をご覧ください。
...
Sequence Embedded Walletソリューションでの認証の仕組みについては、[ドキュメント](/solutions_old/wallets/embedded-wallet/overview)や[ブログ記事](https://sequence.xyz/blog/sequence-embedded-wallets)をご参照ください。
