...
[なぜスマートコントラクトウォレットなのかはこちら](/solutions_old/technical-references/wallet-contracts/why)
...
Sequence の Embedded Wallet ソリューションの認証の仕組みについては、[ドキュメント](/solutions_old/wallets/embedded-wallet/overview)や[ブログ記事](https://sequence.xyz/blog/sequence-embedded-wallets)もご覧ください。
