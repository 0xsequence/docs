...
[Sequence Builder](https://sequence.build) でコレクティブルを作成する必要があります。詳しくは[こちらのガイド](/solutions/builder/contracts/deploy-an-item-collection)をご参照ください。
...
<Note>
  ゲーム内ウォレットについて詳しくは[こちら](/solutions_old/wallets/embedded-wallet/overview)をご参照ください。
</Note>