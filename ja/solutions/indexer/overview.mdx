...
<CardGroup>
  ...
  <Card title="イベント購読" href="/solutions/indexer/event-subscriptions">
    任意のウォレットまたはコントラクトアドレスのイベントを購読します。
  </Card>
...
- [任意のウォレットまたはコントラクトアドレスのイベントを購読](/solutions/indexer/event-subscriptions)