...
この特性と[NanoUniversalDeployer](/solutions_old/technical-references/internals/v1/deploy#1-deploy-nanouniversaldeployer)や[UniversalDeployer](/solutions_old/technical-references/internals/v1/deploy#2-deploy-universaldeployer2)の利用により、Sequenceウォレットは複数のチェーンで同じアドレスを取得できます。
