...
この特性と[NanoUniversalDeployer](/solutions/technical-references/architecture/v1/deploy#1-deploy-nanouniversaldeployer)や[UniversalDeployer](/solutions/technical-references/architecture/v1/deploy#2-deploy-universaldeployer2)の利用により、Sequenceウォレットは複数のチェーンで同じアドレスを取得できます。
