...
[SDKのGitHubリリースページ](https://github.com/0xsequence/sequence-unreal/releases/tag/v3.0.0)からv3をダウンロードして、Ecosystem ウォレットを利用しましょう。ご利用のUnreal Engineバージョンに応じて、いずれかの`.zip`ファイルをダウンロードしてください。
