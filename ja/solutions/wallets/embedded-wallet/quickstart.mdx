...
<Step title="プロジェクトの設定">
	<a href="https://sequence.build/project/default/embedded-wallet?tab=config">Builder 上のプロジェクトの埋め込みウォレット設定ページ</a>にアクセスし、リカバリーウォレットアドレスを入力してパスワードを設定し、
	<b>Create Configuration</b> をクリックしてください。この設定は後から変更できませんのでご注意ください。
</Step>
