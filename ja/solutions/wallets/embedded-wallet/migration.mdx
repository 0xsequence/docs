...
また、Web-SDKを通じてSequence専用の設定変数をセットする必要があります。詳しくは[こちら](https://docs.sequence.xyz/sdk/web/wallet-sdk/embedded/getting-started#setting-up-your-dapp)をご覧ください。

ユーザーが認証された後、SequenceのidTokenを取得し、この[ガイド](https://docs.sequence.xyz/sdk/web/wallet-sdk/embedded/guides/verification)に従ってバックエンドに渡してください。

ここからは、バックエンドやユーザーデータベースの構成に応じて、[ステップ2](https://docs.sequence.xyz/solutions_old/wallets/embedded-wallet/migration#recommended-migration-process)に進み、ユーザーの移行状況を追跡してください。
