...
The Sequence Metadata is integrated directly inside of the respective [Sequence Unity](/sdk/unity/overview) and [Sequence Unreal](/ja/sdk/unreal/introduction) SDKs.