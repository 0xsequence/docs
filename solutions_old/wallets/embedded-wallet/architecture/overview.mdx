...
3. The enclave code is open source and anyone may audit it and verify that the service uses the exact audited version of the source code. [Learn more about verification](/solutions_old/wallets/embedded-wallet/architecture/enclave-verification).
