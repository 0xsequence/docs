...
<CardGroup>
  <Card title="thirdweb to Sequence" icon="book" href="/solutions_old/wallets/embedded-wallet/migration#migrating-from-thirdweb-to-sequence">
...
From here, continue with [Step 2](https://docs.sequence.xyz/solutions_old/wallets/embedded-wallet/migration#recommended-migration-process) depending on your backend and user database to track the migration process for your users.
