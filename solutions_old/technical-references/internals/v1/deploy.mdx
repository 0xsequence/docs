...
The following steps are required to deploy the [Sequence Wallet V1 Context](/solutions_old/technical-references/internals/v1/wallet-context) on a new network.
...
Compile and deploy the contracts in the [Sequence Wallet Context](/solutions_old/technical-references/internals/v1/wallet-context) using the UniversalDeployer2.
