...
<CardGroup cols={2}>
  <Card title="Enforce Royalties" icon="store" href="/solutions/payments/marketplace/overview">
    Enforcing royalties with ERC-2981 to choosing the best trading mechanism for your community, setting fees, and more.
  </Card>
  <Card title="Aggregate Listings" icon="layer-group" href="/solutions/payments/marketplace/hosted/">
  ...
  <Card title="Leverage your Custom Token" icon="coins" href="/solutions/payments/marketplace/hosted/">
    List your collectibles using your custom token to increase utility and engagement.
  </Card>
  <Card title="Video Walkthrough" icon="video" href="/solutions/payments/marketplace/hosted#watch-a-marketplace-be-launched-in-minutes">
...
<CardGroup cols={2}>
  ...
  <Card title="Starter Marketplace" icon="rocket" href="/solutions/payments/marketplace/custom">
