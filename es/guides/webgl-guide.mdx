...
Debe crear un coleccionable desde el [Sequence Builder](https://sequence.build), lo cual puede lograrse siguiendo la siguiente [guía](/solutions/builder/contracts/deploy-an-item-collection).
...
<Note>
  Para obtener más información sobre In-Game Wallets, consulte
  [aquí](/solutions/wallets/developers/embedded-wallet/overview)
</Note>