...
Para desplegar un contrato, puedes seguir [esta guía](/solutions/builder/contracts/deploy-an-item-collection) para desplegar tu ERC1155 y actualizar tu `wrangler.toml` con el `CONTRACT_ADDRESS`.
