...
El primer paso, si aún no lo ha hecho, es [desplegar un smart contract](/solutions/builder/contracts/deploy-an-item-collection) que definirá y representará los NFTs que desea vender a sus jugadores y mostrar en su juego.
