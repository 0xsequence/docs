...
<Steps>
  <Step title="Despliegue un contrato de Primary Sales en Sequence Builder.">
    Primero necesitamos un contrato de Primary Sales junto con un contrato ERC721 que contendrá los ítems de juego que queremos vender. Para hacerlo, siga la [guía](/solutions/builder/contracts/deploy-primary-sales-contract) aquí.
  </Step>
