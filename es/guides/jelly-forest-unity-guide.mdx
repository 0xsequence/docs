...
Conozca [por qué usar smart contract wallets aquí](/solutions_old/technical-references/wallet-contracts/why)
...
Para obtener más información sobre cómo funciona la autenticación en la solución Embedded Wallet de Sequence, consulte nuestra [documentación](/solutions_old/wallets/embedded-wallet/overview) y [entrada de blog](https://sequence.xyz/blog/sequence-embedded-wallets).
