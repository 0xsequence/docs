...
Para una explicación más detallada, vaya a las secciones [Leer desde Blockchain](/es/sdk/unreal/read-from-blockchain/) y [Escribir en Blockchain](/sdk/unreal/write-to-blockchain/).
