...
<Steps>
  ...
  <Step title="Gestión de proyecto y clave de acceso">
    Primero, siga [esta guía](/solutions/builder/project-management) para aprender cómo registrarse en [Sequence Builder](https://sequence.build/) y cómo crear un proyecto.

    Luego, para usar la Transactions API, deberá actualizar su facturación a `Developer`, lo cual puede hacer siguiendo [esta guía](/solutions/builder/project-settings#5-billing-settings).
  ...
  <Step title="Despliegue del contrato de coleccionables">
    Siga [este tutorial](/solutions/builder/contracts/deploy-an-item-collection) para desplegar un contrato de coleccionables.
