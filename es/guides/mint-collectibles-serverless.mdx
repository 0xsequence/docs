...
#### Actualizar metadata
A continuación, deberá actualizar la metadata con sus medios o assets para su contrato, lo cual puede hacer [siguiendo esta guía](/solutions/builder/collections/manage-item-metadata).
