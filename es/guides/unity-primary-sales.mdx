...
- [Sequence Indexer](/solutions/indexer/overview): Aproveche Sequence Indexer para consultar metadatos de NFT y activos del wallet del usuario.
...
Para ello, siga la [guía](/solutions/builder/contracts/deploy-primary-sales-contract) aquí.
