...
El SDK de Sequence Embedded Wallet puede usarse con React Native para una integración completa de Sequence [Embedded Wallet](/solutions/wallets/developers/embedded-wallet/overview) y [Indexer](/api-references/indexer/overview).
...
Siga esta guía para obtener su clave de acceso al proyecto y otras credenciales/llaves: [/solutions/builder/embedded-wallet/configuration](/solutions/builder/embedded-wallet/configuration)
