...
El SDK de Sequence Embedded Wallet puede usarse con React Native para una integración completa de Sequence [Embedded Wallet](/solutions_old/wallets/embedded-wallet/overview) y [Indexer](/api-references/indexer/overview).
