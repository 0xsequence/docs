...
El Sequence Embedded Wallet SDK puede usarse con React Native para una integración completa de [Embedded Wallet](/solutions_old/wallets/embedded-wallet/overview) y [Indexer](/api-references/indexer/overview) de Sequence.
