...
El Sequence Embedded Wallet SDK puede usarse con React Native para una integración completa de Sequence [Embedded Wallet](/solutions/wallets/developers/embedded-wallet/overview) y [Indexer](/api-references/indexer/overview).
