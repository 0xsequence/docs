...
description: Colección de hooks GET para recuperar datos clave del Marketplace. Útil
  para obtener y gestionar información del Marketplace en tu UI.
sidebarTitle: Marketplace Data Hooks
---

## useMarketplaceConfig

El hook useMarketplaceConfig recupera la configuración de tu Marketplace, incluyendo colecciones, enlaces sociales, título y otras configuraciones desde Builder.
...
<ResponseField name="useMarketplaceConfig">
  ...
  <Expandable>
    ...
    <ParamField path="socials" type="MarketplaceSocials">
      Enlaces de redes sociales asociados con el marketplace.
    </ParamField>
    ...
    <ParamField path="collections" type="MarketplaceCollection[]">
      Array de colecciones del marketplace.
    </ParamField>

    <ParamField path="walletOptions" type="MarketplaceWalletOptions">
      Opciones de configuración para integraciones de billetera.
    </ParamField>

    <ParamField path="landingPageLayout" type="string">
      Configuración del diseño para la página de inicio del marketplace.
    </ParamField>
...
El hook useListCollectibles recupera los listados y ofertas actuales en una colección de tu Marketplace. Útil para acceder y gestionar listados y ofertas de manera eficiente.
...
<ResponseField name="useListCollectibles">
  ...
  <Expandable>
    ...
    <ParamField path="fetchNextPage" type="(options?: FetchNextPageOptions) => Promise<UseInfiniteQueryResult>">
      Esta función te permite obtener la siguiente "página" de resultados.
    </ParamField>
  </Expandable>
</ResponseField>
...
El hook useListCollectiblesPaginated recupera y gestiona de manera eficiente los listados y ofertas actuales de tu Marketplace, haciéndolo ideal para mostrar NFTs paginados dentro de una colección.
...
El hook useCountOfCollectables devuelve el número de NFTs en una colección.
