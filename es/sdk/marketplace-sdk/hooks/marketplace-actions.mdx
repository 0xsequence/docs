...
description: Los hooks de acción son esenciales para interactuar con el Marketplace
  en tu aplicación. Útiles para crear listados, hacer ofertas y realizar
...
El hook useCreateListingModal se utiliza para listar un artículo para la venta en el Marketplace. Proporciona la funcionalidad necesaria para crear y gestionar un nuevo listado.
...
El hook useBuyModal permite a los usuarios comprar un NFT que está listado para la venta en el Marketplace. Maneja el proceso de compra y la ejecución de la transacción.
...
El hook useMakeOfferModal permite a los usuarios hacer una oferta por un NFT. Facilita la creación y envío de ofertas dentro del Marketplace.
