---
title: Enviando Tokens ERC-20
description: Cómo enviar tokens ERC-20 usando ethers.js.
---

Puedes solicitar a la wallet que envíe una única transferencia de token ERC-20:
...
Con la funcionalidad de lotes, puedes enviar múltiples transferencias de tokens en una única transacción nativa:
