---
title: Enviando Tokens ERC-721 (NFT)
description: Documentación para enviar ERC721s con Typescript usando la
  infraestructura stack de Sequence para juegos web3.
---

Enviar un NFT ERC-721 es similar a enviar un token ERC-20.
La única diferencia notable está en el estándar del contrato mismo:
...
Con la funcionalidad de procesamiento por lotes, puedes enviar múltiples transferencias de tokens en una sola transacción nativa:
