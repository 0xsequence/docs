...
Como este es un flujo de trabajo muy común, Sequence puede autenticar automáticamente la dirección de la cuenta al mismo tiempo que se le solicita al usuario conectar su wallet a su aplicación. Esto permite que la experiencia del usuario sea más simple y fluida.
