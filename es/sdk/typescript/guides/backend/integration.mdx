...
<Steps>
  ...
  <Step>
    Debe configurar GCP KMS para obtener las variables de entorno requeridas.
    Consulte una guía basada en nuestra solución Sidekick [aquí](https://docs.sequence.xyz/solutions/infrastructure/sidekick/overview#:~:text=GCP-,KMS,-Configuration%3A)
  </Step>
...
<Steps>
  ...
  <Step>
    Debe configurar AWS KMS para obtener las variables de entorno requeridas.
    Consulte una guía basada en nuestra solución Sidekick [aquí](https://docs.sequence.xyz/solutions/infrastructure/sidekick/overview#:~:text=AWS-,KMS,-Configuration%3A)
  </Step>
