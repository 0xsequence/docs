---
title: Impulse su juego de Wallet del Ecosistema
...
Importe nuestros Boilerplates desde las muestras `Demo` en la interfaz de Package Manager.
Cree los Boilerplates usando el `BoilerplateFactory` como se muestra a continuación. Siéntase libre de ajustar la interfaz y la lógica dentro de las muestras según sus necesidades.
