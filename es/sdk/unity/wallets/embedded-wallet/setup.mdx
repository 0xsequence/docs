...
<Steps>
  ...
  <Step title="Integre su proceso de inicio de sesión">
    ...
    Si eso devuelve `false`, debe pedirle al usuario que firme. Importe el ejemplo `Setup` desde la interfaz del Package Manager, lo que colocará un conjunto de plantillas en su proyecto dentro del directorio `Resources/`. Cree el [Login Boilerplate](/sdk/unity/bootstrap) para enviar una contraseña de un solo uso a la dirección de correo electrónico especificada.

    Una vez que haya integrado sus primeras funciones, puede continuar con [proveedores de inicio de sesión adicionales](/sdk/unity/wallets/embedded-wallet/onboard/authentication/intro) como Google, Apple o PlayFab.
  ...
  <Step title="Pruebe las funciones de Sequence">
    El SDK de Unity de Sequence incluye una variedad de [Boilerplates](/sdk/unity/bootstrap) para ayudarle a iniciar su juego rápidamente.
    Una vez que todo esté configurado, puede crear prefabs para mostrar un perfil de jugador, inventario o tienda dentro del juego.
    Vea [cómo integrar un perfil de jugador](/sdk/unity/bootstrap)
  ...
  <Step title="Intégrelo por su cuenta">
    Comience con el `EmbeddedWalletAdapter` para iniciar su integración rápidamente con solo unas líneas de código y estará listo para continuar.
    Cuando quiera personalizar su integración, consulte nuestra documentación sobre [cómo autenticar usuarios](/sdk/unity/wallets/embedded-wallet/onboard/authentication/intro) o [cómo enviar transacciones](/sdk/unity/wallets/embedded-wallet/blockchain-interactions)
