...
Para transferir ETH (o la moneda de gas para su red), se recomienda usar
...
Entre bastidores, esto creará un
`GasLimitEstimator`que construirá la transacción por usted - incluyendo la determinación del gasPrice, gasLimit y nonce apropiados.
