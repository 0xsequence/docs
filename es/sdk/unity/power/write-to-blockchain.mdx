...
<Info>El patrocinio de transacciones solo está disponible para el nivel Developer y superiores. Para más información sobre el patrocinio de gas, consulte [este documento](/solutions/builder/gas-sponsorship). Para más información sobre cómo actualizar el nivel de facturación de su proyecto, consulte [esta guía](/solutions/builder/project-settings#update-your-project-subscription-plan).</Info>
