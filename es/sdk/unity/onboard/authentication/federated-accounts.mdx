...
<Tip>Una vez que el usuario haya cerrado sesión, no olvide llamar a `SetConnectedWalletAddress(null)` para reconfigurar SequenceLogin y volver a crear sesiones nuevas.</Tip>
