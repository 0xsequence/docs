...
Como Embedded Wallet SDK, la autenticación es sumamente importante. La autenticación funciona estableciendo una wallet de firma de sesión asociada a las credenciales del usuario. Para más detalles sobre cómo funciona nuestro Embedded Wallet, consulte la [documentación de Embedded Wallet](/solutions/wallets/developers/embedded-wallet/overview).
