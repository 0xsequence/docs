...
En general, recomendamos usar nuestros contratos de ventas primarias auditados que se pueden [implementar fácilmente desde el Sequence Builder](/solutions/builder/contracts/deploy-primary-sales-contract).
...
Una vez que haya [configurado su contrato de Venta Primaria en el Sequence Builder](/solutions/builder/contracts/deploy-primary-sales-contract), puede que quiera obtener esos detalles en Unity.
...
<Tip>¡No olvide agregar las direcciones de sus contratos de ventas primarias y de la moneda de precio a su [Gas Tank](/solutions/builder/gas-sponsorship) si desea que estas transacciones sean patrocinadas!</Tip>