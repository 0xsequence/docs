...
En general, recomendamos usar nuestros contratos de ventas primarias auditados que pueden [desplegarse fácilmente desde Sequence Builder](/solutions/builder/contracts/deploy-primary-sales-contract).
...
Una vez que haya [configurado su contrato de venta primaria en Sequence Builder](/solutions/builder/contracts/deploy-primary-sales-contract), puede que desee obtener esos detalles en Unity.
...
<Tip>¡No olvide agregar sus contratos de ventas primarias y las direcciones de contrato de la moneda de precio a su [Gas Tank](/solutions/builder/gas-sponsorship) si quiere que estas transacciones sean patrocinadas!</Tip>