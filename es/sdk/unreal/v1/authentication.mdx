...
Visite nuestra página de [Requisitos de Plataforma](/sdk/unreal/v1/platforms) para información detallada sobre la configuración y para asegurarse de que los métodos de autenticación elegidos estén correctamente configurados en su proyecto del Builder.
...
Utilice este método para iniciar una sesión usando un Id token válido de Google o Apple.
...
durante la [Configuración](/sdk/unreal/v1/configuration) y [configurar PlayFab en el Builder](/solutions/builder/embedded-wallet/playfab-configuration).
