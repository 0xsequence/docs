...
El Sequence Unreal Embedded Wallet SDK proporciona integración completa de Sequence [Embedded Wallet](/solutions/wallets/embedded-wallet/overview), [Indexer](/api-references/indexer/overview) para juegos desarrollados con Unreal Framework.
