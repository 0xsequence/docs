...
El SDK de Sequence Unreal Embedded Wallet proporciona integración completa de Sequence [Embedded Wallet](/solutions/wallets/developers/embedded-wallet/overview) y [Indexer](/api-references/indexer/overview) para juegos desarrollados en el Unreal Framework.
