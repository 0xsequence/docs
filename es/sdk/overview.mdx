    ...
    <div className="px-6 py-5">
      ...
      <div>
        ...
        <div className="mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400">
          <p>Una pila completa de desarrollo web3 para crear aplicaciones y juegos en cadenas de Ethereum. Incluye integración de wallet, gestión de transacciones e interacción con contratos inteligentes.</p>
        </div>
      </div>
    </div>
  </a>
  ...
  <a className="card block not-prose font-normal group relative my-2 ring-2 ring-transparent rounded-2xl bg-white dark:bg-background-dark border border-gray-950/10 dark:border-white/10 overflow-hidden w-full cursor-pointer hover:!border-primary dark:hover:!border-primary-light" href="/sdk/marketplace-sdk/overview">
    <div className="px-6 py-5">
      ...
      <div>
        ...
        <div className="mt-1 font-normal text-sm leading-6 text-gray-600 dark:text-gray-400">
          <p>Marketplace SDK es un kit de herramientas completo que integra fácilmente nuestros marketplaces en aplicaciones. Soporta NFTs (ERC721) y tokens semi-fungibles (ERC1155).</p>
        </div>
      </div>
    </div>
  </a>
...
- Use el [Unreal SDK](/sdk/unreal/overview) para juegos en Unreal Engine.
