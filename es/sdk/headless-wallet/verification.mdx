---
title: Verificación de Wallet Headless
...
<Note>
  Si no está usando Embedded Wallet con TypeScript y en su lugar trabaja con el Web SDK, puede ir [aquí](/sdk/web/wallet-sdk/embedded/guides/verification) para ver cómo manejar el proceso de verificación.
</Note>
