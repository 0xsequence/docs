...
- **Contrato o wallet patrocinado**: Si el smart contract o wallet está patrocinado, no se requiere ingresar una opción de comisión en la llamada al SDK. Puede aprender cómo patrocinar un contrato o wallet [aquí](/solutions/builder/gas-sponsorship.mdx).
