...
- **Contrato o Wallet patrocinado**: Tener el smart contract o wallet patrocinado, sin requerir la opción de comisión en la llamada al SDK. Puede aprender cómo patrocinar un contrato o wallet [aquí](/solutions/builder/gas-sponsorship.mdx).
...
Puede transferir tokens a su wallet, o utilizar la [función de on-ramp](/sdk/web/wallet-sdk/embedded/guides/on-ramp) con la solución Web SDK.
