...
| ----------------------- | -------------------------------------------- | ---------------------------------------------------------------------------------- |
| `collectibles`          | `Array<{tokenId: string, quantity: string}>` | Array de coleccionables para comprar                                               |
...
| `recipientAddress`      | `string`                                     | Dirección para recibir los elementos comprados                                     |
| `currencyAddress`       | `string`                                     | Dirección del contrato del token de moneda                                         |
| `collectionAddress`     | `string`                                     | Dirección del contrato de la colección NFT                                         |
| `creditCardProviders`   | `string[]`                                   | Lista de proveedores de tarjetas de crédito soportados (ej., 'sardine', 'transak') |
| `transakConfig`         | `object`                                     | Configuración para la integración de Transak                                       |
| `copyrightText`         | `string`                                     | Texto de copyright para mostrar en el modal                                        |
...
* Pagar con criptomoneda desde la billetera del usuario
* Intercambiar tokens para pagar con una criptomoneda diferente
* Pagar con tarjeta de crédito/débito
* Recibir fondos desde otra billetera
