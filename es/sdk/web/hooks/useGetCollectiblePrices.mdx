...
description: Gancho para obtener los precios actuales del mercado para NFTs/coleccionables
...
Array de tokens para obtener precios. Cada token debe incluir:
...
El gancho devuelve un objeto de resultado de React Query:
