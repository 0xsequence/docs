...
description: Hook para obtener las tasas de cambio actuales de USD a otras monedas
...
El código de la moneda objetivo (por ejemplo, 'EUR', 'GBP', 'JPY'). Si se proporciona 'USD', devuelve 1 como tasa de conversión.
...
El hook devuelve un objeto de resultado de React Query:
