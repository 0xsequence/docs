...
description: Hook para obtener información de contratos para múltiples tokens y NFTs en paralelo
...
El hook devuelve todas las propiedades de React Query's `UseQueryResult` con un array de información de contratos. Aquí está la estructura detallada:
...
Array de objetos que contienen información del contrato para cada contrato solicitado:
...
* `verified`: Si el contrato está verificado
...
* `chainID`: ID de la cadena donde existe el contrato
