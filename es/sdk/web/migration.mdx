---
title: Migrar a v5 (Web SDK)
description: Sequence Kit (v4) ahora es Web SDK (v5). Aquí están los cambios más importantes.
...
## Tailwind css
Web SDK utiliza Tailwind v4. Si está usando Tailwind v3, necesita actualizar.