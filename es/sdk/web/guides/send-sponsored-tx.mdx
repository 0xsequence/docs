...
<Steps>
  ...
  <Step title="Configure su Gas Tank (solo para Mainnet)">
    Si planea enviar transacciones en mainnet, necesita configurar su gas tank. Vaya a [Gas Sponsorhip](/solutions/builder/gas-sponsorship) para aprender cómo configurarlo.
