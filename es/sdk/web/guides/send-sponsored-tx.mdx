...
<Steps>
  ...
  <Step title="Configure su Gas Tank (solo para Mainnet)">
    Si planea enviar transacciones en mainnet, debe configurar su gas tank. Visite [Gas Sponsorship](/solutions/builder/gas-sponsorship) para aprender cómo configurarlo.
