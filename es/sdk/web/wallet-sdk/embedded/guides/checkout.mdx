...
<Note>
  Para habilitar pagos con tarjeta de crédito en el checkout, póngase en contacto con el equipo de Sequence, ya que su dirección de contrato deberá ser allowlisted y su organización deberá pasar por un proceso KYB. Los pagos con tarjeta de crédito solo funcionan en las mainnets de varias redes.
</Note>
