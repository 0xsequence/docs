  ...
  <Tab title="Aplicación Vite">
    <Steps>
      ...
      <Step title="Cree su configuración de Wallet">
        ...
        El `walletUrl` es la URL del Ecosystem Wallet que su dApp utilizará; para nuestra demo, usamos Sequence Ecosystem Wallet [https://v3.sequence.app](https://v3.sequence.app).
      ...
      <Step title="Configurar el componente Provider">
        La configuración que creamos en el [paso 2](/sdk/web/wallet-sdk/ecosystem/getting-started#create-a-config) debe pasarse al `SequenceConnect config`
