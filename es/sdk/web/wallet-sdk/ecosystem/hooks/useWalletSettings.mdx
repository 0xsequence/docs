...
Indica si las wallets externas están ocultas en el Connect Modal.

#### hideConnectedWallets
`boolean | undefined`

Indica si las wallets conectadas están ocultas en el Connect Modal.

#### hideSocialConnectOptions
`boolean | undefined`

Indica si las wallets sociales (inicio de sesión con redes sociales o correo) están ocultas en el Connect Modal.
