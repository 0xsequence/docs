...
1. **Conectar y confiar:** Usted conecta su wallet a una app (por ejemplo, `app.my-defi-protocol.com`)
...
1.  **La propuesta de la app:** La app presenta a su wallet una lista de permisos muy específicos que necesita. Por ejemplo:
