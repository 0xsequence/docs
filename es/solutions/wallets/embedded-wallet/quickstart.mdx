...
<Step title="Configure su proyecto">
	<a href="https://sequence.build/project/default/embedded-wallet?tab=config">Vaya a la configuración de embedded wallet</a> para su proyecto en Builder. Ingrese la dirección de su wallet de recuperación y establezca una
	contraseña, luego haga clic en <b>Create Configuration</b>. Tenga en cuenta que esta configuración no podrá modificarse más adelante.
</Step>
