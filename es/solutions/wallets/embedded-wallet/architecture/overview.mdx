...
3. El código del enclave es open source y cualquier persona puede auditarlo y verificar que el servicio utiliza exactamente la versión auditada del código fuente. [Más información sobre la verificación](/solutions_old/wallets/embedded-wallet/architecture/enclave-verification).
