...
3. El código del enclave es open source y cualquier persona puede auditarlo y verificar que el servicio utiliza exactamente la versión auditada del código fuente. [Más información sobre la verificación](/solutions/technical-references/architecture/embedded-wallets/enclave-verification).
