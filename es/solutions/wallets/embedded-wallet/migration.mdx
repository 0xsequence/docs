...
<CardGroup>
  <Card title="De thirdweb a Sequence" icon="book" href="/solutions_old/wallets/embedded-wallet/migration#migrating-from-thirdweb-to-sequence">
...
A partir de aquí, continúe con el [Paso 2](https://docs.sequence.xyz/solutions_old/wallets/embedded-wallet/migration#recommended-migration-process) según su backend y base de datos de usuarios para hacer seguimiento al proceso de migración de sus usuarios.
