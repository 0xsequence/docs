...
<CardGroup>
  <Card title="De ThirdWeb a Sequence" icon="book" href="/solutions/wallets/embedded-wallet/migration#how-to-migrate-from-thirdweb-to-sequence">
    Siga esta guía para migrar de ThirdWeb In-App Wallets a Sequence.
  </Card>
</CardGroup>

## Proceso de migración recomendado
El proceso de migración está diseñado para que los usuarios pasen de su proveedor de wallet actual a Sequence Embedded Wallets sin afectar su experiencia. Este proceso ocurre automáticamente cuando el usuario inicia sesión por primera vez después de implementar la migración, siguiendo generalmente estos pasos:
