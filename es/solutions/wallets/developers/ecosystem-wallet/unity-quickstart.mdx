...
Siga nuestra [Unity Setup](/sdk/unity/ecosystem-wallet/setup) para configurar el SDK de Unity.
...
Ahora, creemos la interfaz `SequenceConnect` con estos permisos para crear una sesión de wallet.
