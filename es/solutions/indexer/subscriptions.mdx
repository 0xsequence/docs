---
title: Suscripciones
description: Suscríbase a eventos, recibos y actualizaciones de saldo para cualquier wallet o dirección de contrato.
sidebarTitle: Suscripciones
---

## Suscribirse a eventos de Blockchain
Puede suscribirse en tiempo real a diferentes eventos de blockchain usando los endpoints de suscripción. Utilice filtros para escuchar direcciones de contratos, direcciones de cuentas y/o IDs de tokens específicos.
