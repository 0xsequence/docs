...
<Steps>
  ...
  <Step title="Paso 2: Implemente el contrato de coleccionables elegido">
    Siga esta [guía](/solutions/builder/contracts/deploy-an-item-collection) para desplegar un contrato de coleccionables y cargar los metadatos de la colección para la que desea crear una venta.
