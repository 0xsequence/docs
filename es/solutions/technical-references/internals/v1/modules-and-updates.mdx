...
El `MainModule` es el módulo inicial de toda wallet Sequence; se diferencia de otros módulos porque no almacena el conjunto de firmantes en el almacenamiento del contrato; utiliza el [salt](/solutions_old/technical-references/internals/v1/wallet-factory) proporcionado a Factory.
...
Consulte [Calcular dirección del wallet](/solutions_old/technical-references/internals/v1/wallet-configuration).