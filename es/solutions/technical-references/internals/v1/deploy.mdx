...
Los siguientes pasos son necesarios para desplegar el [Contexto de Sequence Wallet V1](/solutions_old/technical-references/internals/v1/wallet-context) en una nueva red.
...
Compile y despliegue los contratos en el [Wallet Context de Sequence](/solutions_old/technical-references/internals/v1/wallet-context) usando el UniversalDeployer2.
