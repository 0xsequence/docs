...
Esta propiedad, junto con el uso de [NanoUniversalDeployer](/solutions/technical-references/architecture/v1/deploy#1-deploy-nanouniversaldeployer) o [UniversalDeployer](/solutions/technical-references/architecture/v1/deploy#2-deploy-universaldeployer2), es la razón por la que los Sequence wallets pueden obtener la misma dirección en múltiples cadenas.
