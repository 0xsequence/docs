...
Se requieren los siguientes pasos para desplegar el [Sequence Wallet Context](/solutions_old/technical-references/internals/v1/wallet-context) en una nueva red.
...
Despliegue cada uno de los contratos en el [Sequence Wallet Context](/solutions_old/technical-references/internals/v1/wallet-context) usando el Singleton Factory.
