...
Se requieren los siguientes pasos para desplegar el [Sequence Wallet Context](/solutions/technical-references/architecture/v1/wallet-context) en una nueva red.
...
Despliegue cada uno de los contratos en el [Sequence Wallet Context](/solutions/technical-references/architecture/v1/wallet-context) usando el Singleton Factory.
