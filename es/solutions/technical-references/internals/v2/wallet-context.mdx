...
description: Este fragmento de código define el contexto de la billetera v2, incluyendo las direcciones para la fábrica, módulo principal, módulo principal actualizable, módulo de invitados y utilidades de sequence.
---
