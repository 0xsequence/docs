...
- v1: [Desplegar contratos v1](/solutions_old/technical-references/internals/v1/deploy)
- v2: [Desplegar contratos v2](/solutions_old/technical-references/internals/v2/deploy)