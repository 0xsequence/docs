...
- v1: [Desplegar contratos v1](/solutions/technical-references/architecture/v1/deploy)
- v2: [Desplegar contratos v2](/solutions/technical-references/architecture/v2/deploy)