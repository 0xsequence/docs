---
title: Obtener saldos en todas las redes
description: Este contenido proporciona instrucciones sobre cómo obtener detalles de datos de tokens
  de contratos específicos a través de todas las diferentes redes.
---

# APIs de saldos de tokens

En los siguientes ejemplos, vamos a usar el `GetTokenBalancesSummary` y
`GetTokenBalancesDetails` métodos de Sequence Indexer Gateway.
...
* Cuerpo (en JSON):
  ...
  * `omitMetadata` (booleano - opcional - predeterminado: false)
...
### Obtener el resumen de saldos de tokens verificados en redes específicas

Ejemplo: Obtener el resumen de todos los saldos de tokens verificados para una cuenta específica en `mainnet` y `polygon`
...
### Obtener detalles de saldo de contratos específicos en todas las redes

Ejemplo: Obtener los detalles de saldo de los contratos USDC en Arbitrum, Polygon y Mainnet
