---
title: Obtener saldos de tokens de contratos específicos en todas las redes.
description: Este contenido proporciona instrucciones sobre cómo obtener saldos de tokens de
  contratos específicos.
---

# API de Actualizaciones de Saldo

En los siguientes ejemplos, vamos a usar la `GetTokenBalancesByContract`
API.
...
### Obtener los saldos de USDC

Ejemplo: Recuperar saldos de tokens USDC para una cuenta específica (`0xd8da6bf26964af9d7eed9e03e53415d37aa96045`) a través de múltiples redes
