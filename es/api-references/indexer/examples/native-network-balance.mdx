---
title: Balances de red nativa (por ejemplo, ETH, MATIC, etc.)
sidebarTitle: Balance de red nativa
---

## Obtenga el balance de la red nativa (también conocido como ETH en Ethereum, MATIC en Polygon, AVAX en Avalanche, BNB en BSC, etc.)
_Método `GetEtherBalance` de Sequence Indexer:_
- Solicitud: POST /rpc/Indexer/GetEtherBalance
- Content-Type: application/json
- Cuerpo (en JSON):
  - `accountAddress` (string) -- la dirección de cuenta del wallet

**Ejemplo: `GetEtherBalance` balance de MATIC de una dirección de cuenta de wallet en Polygon usando un `API_Access_Key`**
