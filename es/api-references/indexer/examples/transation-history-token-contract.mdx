...
## Obtener / escuchar el historial de transacciones para cualquier contrato ERC20, ERC721, ERC1155.
...
<Note>
  La retención del historial de transacciones del contrato de token con el Indexador es de 30 días para todas las redes (con la excepción de `arbitrum-sepolia` que es de 20 días).
</Note>

**Ejemplo: `GetTransactionHistory` del contrato de Skyweaver en Polygon usando un `API_ACCESS_KEY`**
