...
<Warning>
  ¡La selección de tarifas solo es necesaria si no estás utilizando las capacidades de patrocinio de gas de Sequence Builder!
  ¡Crea tu proyecto en Sequence Builder para facilitar el desarrollo hoy!
</Warning>
