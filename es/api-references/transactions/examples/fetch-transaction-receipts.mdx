---
title: Obtener recibos de transacciones
sidebarTitle: Obtener recibos de transacciones
---

Para obtener el recibo de una transacción arbitraria que fue enviada a través de la Transactions API, llame al endpoint `/GetMetaTxnReceipt`.
