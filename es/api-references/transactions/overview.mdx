...
Lo mejor de todo: las transacciones con la API de Transacciones de Sequence son compatibles con cualquier contrato de Ethereum existente/desplegado, por lo que integrar el Sequence Relayer no requiere ningún cambio en sus contratos ni en su aplicación.

La API de Transacciones de Sequence puede usarse tanto en aplicaciones frontend como en backends. Asegúrese de instalar el SDK correspondiente para su lenguaje preferido, como [Typescript](/sdk/typescript/overview) o [Go](/sdk/go/overview).
