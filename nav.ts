    ...
    },
    {
      ...
      items: [
        ...
        { text: 'API References', link: '/api/indexer-gateway/endpoints' },
        {
          ...
          collapsed: false,
          items: [
            { text: 'Fetch Tokens', link: '/api/indexer-gateway/examples/get-token-balances' },
            { text: 'Fetch Native Balances', link: '/api/indexer-gateway/examples/get-native-token-balances' },
            { text: 'Fetch Balance updates', link: '/api/indexer-gateway/examples/get-balance-updates' },
            { text: 'Advanced token filtering', link: '/api/indexer-gateway/examples/get-token-balances-details' },
            { text: 'Fetch by contract', link: '/api/indexer-gateway/examples/get-token-balances-by-contract' },
          ],
        },
      ],
    },
