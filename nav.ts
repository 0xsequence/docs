...
import { messages as en } from "./docs/locales/nav/en";
import { messages as ja } from "./docs/locales/nav/ja";

i18n.load("ja", ja);
i18n.loadAndActivate({ locale: "en", locales: ["en", "ja"], messages: en });
      ...
      items: [
        {
          ...
          match: "ja/solutions/builder/overview",
        },
      ],
    },
  ],
