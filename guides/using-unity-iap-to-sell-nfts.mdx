...
The first step, if you haven't done so already, is to [deploy a smart contract](/solutions/builder/contracts/deploy-an-item-collection) that will define and represent the NFTs you aim to sell to your players and display in your game.
