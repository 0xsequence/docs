...
2. [Integrate Sequence Kit](/guides/webgl-guide#2-integrate-sequence-kit): Allow all EOAs and Sequence Wallet to authenticate the user
...
7. [(Optional) Integrate Embedded Wallet Into Sequence Kit](/guides/webgl-guide#7-optional-integrate-embedded-wallet-into-sequence-kit): Enable smooth UX without the use of signer signed messages
...
[Template WebGL JS Sequence Kit Starter](https://github.com/0xsequence-demos/template-webgl-js-sequence-kit-starter/tree/simple-start)
