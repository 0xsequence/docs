...
Learn [why smart contract wallets here](/solutions_old/technical-references/wallet-contracts/why)
...
For more information on how auth in Sequence's Embedded Wallet solution works, please see our [docs](/solutions_old/wallets/embedded-wallet/overview) and [blog post](https://sequence.xyz/blog/sequence-embedded-wallets).
