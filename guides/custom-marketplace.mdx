...
Your choice from the Sequence stack is to use either an [Embedded Wallet](/sdk/headless-wallet/quickstart) for headless and web2-like UX, or a [Ecosystem Wallet](/solutions/wallets/ecosystem/overview) with [Sequence Kit](/solutions/wallets/overview) to reach more types of wallets.
