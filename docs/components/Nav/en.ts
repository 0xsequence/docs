      ...
      items: [
        { text: i18n._("Overview"), link: "/solutions/wallets/overview" },
        {
          ...
          items: [
            ...
            { text: i18n._("Cross-App Integration"), link: "/solutions/wallets/ecosystem/cross-app" },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: i18n._("On-ramp"), link: "/solutions/wallets/embedded-wallet/examples/on-ramp" },
                {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: i18n._("Smart Swaps"), link: "/solutions/wallets/sequence-kit/smart-swaps" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: i18n._("Supported Platforms"), link: "/solutions/wallets/universal-wallet/platforms" },
            { text: i18n._("Fiat On-Ramps"), link: "/solutions/wallets/universal-wallet/fiat-on-ramps" },
            { text: i18n._("Key Management"), link: "/solutions/wallets/universal-wallet/key-management" },
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: i18n._("On-Ramp Funds via Credit Card"), link: "/sdk/unity/onboard-user-funds" },
            {
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: i18n._("Signing & Verifying Messages"), link: "/sdk/typescript/guides/sign-message" },
            {
              text: i18n._("No-wallet confirmation signatures"),
              link: "/sdk/typescript/guides/session-keys",
            },
            { text: i18n._("Sending Transactions"), link: "/sdk/typescript/guides/send-transaction" },
            { text: i18n._("Sending ERC-20 Tokens"), link: "/sdk/typescript/guides/send-erc20" },
            { text: i18n._("Sending ERC-721 (NFT) Tokens"), link: "/sdk/typescript/guides/send-erc721" },
            {
              text: i18n._("Sending ERC-1155 (Collectible) Tokens"),
  ...
  "/api": [
    {
      ...
      items: [
        ...
        { text: i18n._("API References"), link: "/api/transactions/endpoints" },
        {
          ...
          collapsed: false,
          items: [
            { text: i18n._("Fetch Fee Options"), link: "/api/transactions/examples/fetch-fee-options" },
            { text: i18n._("Send Transactions"), link: "/api/transactions/examples/send-transactions" },
            {
      ...
      items: [
        ...
        { text: i18n._("API References"), link: "/api/indexer/endpoints" },
        {
          ...
          items: [
            ...
            { text: i18n._("Transaction History"), link: "/api/indexer/examples/transaction-history" },
      ...
      items: [
        ...
        // { text: i18n._('Marketplace API'), link: '/api/marketplace/api' },
        {
          ...
          items: [
            ...
            { text: i18n._("Get User Activities"), link: "/api/marketplace/examples/get-user-activities" },
          ],
        },
      ],
    },
