      ...
      items: [
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: i18n._("On-ramp"), link: "/ja/solutions/wallets/embedded-wallet/examples/on-ramp" },
                {
        ...
        },
        {
          ...
          items: [
            ...
            { text: i18n._("Quickstart"), link: "/ja/solutions/wallets/sequence-kit/getting-started" },
            {
            ...
            },
            {
              ...
              items: [
                ...
                { text: i18n._("Smart Swaps"), link: "/ja/solutions/wallets/sequence-kit/smart-swaps" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: i18n._("Quickstart"), link: "/ja/solutions/wallets/universal-wallet/quickstart" },
            {
              text: i18n._("Examples"),
              collapsed: true,
              items: [
            ...
            { text: i18n._("Supported Platforms"), link: "/ja/solutions/wallets/universal-wallet/platforms" },
            { text: i18n._("Fiat On-Ramps"), link: "/ja/solutions/wallets/universal-wallet/fiat-on-ramps" },
            { text: i18n._("Key Management"), link: "/ja/solutions/wallets/universal-wallet/key-management" },
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: i18n._("On-Ramp Funds via Credit Card"), link: "/ja/sdk/unity/onboard-user-funds" },
            {
              text: i18n._("Peer to Peer Trading / Marketplace"),
              collapsed: false,
              items: [
                { text: i18n._("Introduction"), link: "/ja/sdk/unity/marketplace/intro" },
                { text: i18n._("Reading Orders"), link: "/ja/sdk/unity/marketplace/reading-orders" },
                { text: i18n._("Filling Orders"), link: "/ja/sdk/unity/marketplace/filling-orders" },
            ...
            { text: i18n._("Upgrading from v2 to v3"), link: "/ja/sdk/unity/v2-to-v3-upgrade-guide" },
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: i18n._("Signing & Verifying Messages"), link: "/ja/sdk/typescript/guides/sign-message" },
            {
              text: i18n._("No-wallet confirmation signatures"),
              link: "/ja/sdk/typescript/guides/session-keys",
            },
            { text: i18n._("Sending Transactions"), link: "/ja/sdk/typescript/guides/send-transaction" },
            { text: i18n._("Sending ERC-20 Tokens"), link: "/ja/sdk/typescript/guides/send-erc20" },
            { text: i18n._("Sending ERC-721 (NFT) Tokens"), link: "/ja/sdk/typescript/guides/send-erc721" },
            {
              text: i18n._("Sending ERC-1155 (Collectible) Tokens"),
            ...
            },
            {
              ...
              items: [
                ...
                { text: i18n._("Web3 Onboard"), link: "/ja/sdk/typescript/connectors/web3-onboard" },
                { text: i18n._("Web3 React V6"), link: "/ja/sdk/typescript/connectors/web3-react-v6" },
  ...
  "/ja/api": [
    {
      ...
      items: [
        ...
        { text: i18n._("API References"), link: "/ja/api/transactions/endpoints" },
        {
          ...
          collapsed: false,
          items: [
            { text: i18n._("Fetch Fee Options"), link: "/ja/api/transactions/examples/fetch-fee-options" },
            { text: i18n._("Send Transactions"), link: "/ja/api/transactions/examples/send-transactions" },
            {
      ...
      items: [
        ...
        { text: i18n._("API References"), link: "/ja/api/indexer/endpoints" },
        {
          ...
          items: [
            ...
            { text: i18n._("Transaction History"), link: "/ja/api/indexer/examples/transaction-history" },
      ...
      items: [
        ...
        // { text: i18n._('Marketplace API'), link: '/ja/api/marketplace/api' },
        {
          ...
          items: [
            ...
            { text: i18n._("Get User Activities"), link: "/ja/api/marketplace/examples/get-user-activities" },
          ],
        },
      ],
    },
