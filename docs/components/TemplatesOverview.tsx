...
const CodeSnippet = ({ code }: { code: string }) => (
  <div>
    <p className="py-2 text-themed-secondary text-md font-medium leading-6">
...
export const TemplatesOverview = () => {
  ...
  return (
    <section className="flex flex-col gap-5 border-t dark:border-white-10 border-black-10">
      ...
      <div className="flex flex-wrap gap-4 md:flex-row flex-col">
        <TemplateCard
          title={t`Sequence Kit w/ Embedded Wallet for React Boilerplate`}
          body={t`Example boilerplate showcasing embedded wallet integrated with Sequence Kit in a simple React application.`}
        ...
        />
        <TemplateCard
          title={t`Sequence Kit w/ Embedded Wallet for NextJS Boilerplate`}
          body={t`Example boilerplate showcasing embedded wallet integrated with Sequence Kit in a simple NextJS application.`}
        ...
        />
        <TemplateCard
          title={t`Embedded Wallet Boilerplate for Wallet Verification on a backend.`}
          body={t`Example for your web application to verify the ownership of an Embedded Wallet by passing a JWT and validating against the Sequence API.`}
          link="https://github.com/0xsequence-demos/embedded-wallet-verify-session"
        />
        <TemplateCard
          title={t`Embedded Wallet Boilerplate for Unreal Engine`}
          body={t`Example application made with our Unreal SDK, showcasing embedded wallet integrated to sign messages and send ERC20 transactions.`}
          link="https://github.com/0xsequence/unreal-embedded-wallet-boilerplate"
        />
        <TemplateCard
          title={t`End to End playground for Sequence Kit`}
          body={t`Example implementation in React & NextJS showcasing various common patterns using Sequence Kit such as signingv messages, sending transactions, displaying inventory, or minting an NFT.`}
          link="https://github.com/0xsequence/kit/tree/master/examples"
          demolink="https://0xsequence.github.io/kit/"
        />
        <TemplateCard
          title={t`Embedded Wallet Demo using Wallet Linking`}
          body={t`Example application to allow players to link other EOA wallets they own for transferring assets or for verification purposes. The demo can be used by clicking EOA Link via the demo button below to see the flow.`}
      ...
      <div className="flex flex-wrap gap-4 md:flex-row flex-col">
        <h4 className="text-2xl text-themed-primary font-bold">
          <Trans>Monetization</Trans>
        </h4>
      </div>
      <div className="flex flex-wrap gap-4 md:flex-row flex-col">
        <TemplateCard
          title={t`Custom Marketplace Boilerplate`}
          body={t`Open-source boilerplate of our white-label marketplace leveraging our marketplace APIs that can be completely customized to fit your game or use case.`}
      ...
      <div className="flex flex-wrap gap-4 md:flex-row flex-col">
        <TemplateCard
          title={t`Transactions API Template using a Cloudflare Worker`}
          body={t`Example template for integrators allow users to mint collectibles using the Sequence Transactions API for gasless serverless transactions for infrastructure that can scale elastically.`}
