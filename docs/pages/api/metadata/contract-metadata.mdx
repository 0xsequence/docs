...
* [Learn about querying contract-level info metadata extensions for ERC20, ERC721 and ERC1155 tokens](/api/metadata/contract-metadata#search-contract-metadata)
