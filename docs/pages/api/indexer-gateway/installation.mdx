---
title: Sequence Indexer Gateway API Installation Guide
...
To install Indexer Gateway, follow the instructions for [installing Indexer](/api/indexer/installation).
