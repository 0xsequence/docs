...
here](/solutions/technical-references/chain-support).
...
- [Fetch tokens & NFTS in any wallet across all chains, including
  metadata](/api/indexer-gateway/examples/get-token-balances)

- [Fetch native balances across all
  chains](/api/indexer-gateway/examples/get-native-token-balances)

- [Fetch balance updates across all
  chains](/api/indexer-gateway/examples/get-balance-updates)

- [Fetch tokens with advanced
  filters](/api/indexer-gateway/examples/get-token-balances-details)

- [Fetch tokens, by contract, with advanced
  filters](/api/indexer-gateway/examples/get-token-balances-by-contract)
