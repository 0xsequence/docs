...
curl -X POST \
  ...
  -d '{"url": "<URL>","filters": {"contractAddresses":["0x631998e91476DA5B870D741192fc5Cbc55F5a52E"]}}' \
  https://polygon-indexer.sequence.app/rpc/Indexer/AddWebhookListener
```
...
curl -X POST \
  ...
  https://polygon-indexer.sequence.app/rpc/Indexer/RemoveWebhookListener
```
...
curl -X POST \
  ...
  -H "X-Access-Key: <project_access_key>" \
  -H "Authorization: BEARER <secret_API_key>" \
  -d '{"url": "<URL>", "filters": {"contractAddresses":["0x9bec34c1f7098e278afd48fedcf13355b854364a"]}}' \
  https://polygon-indexer.sequence.app/rpc/Indexer/AddWebhookListener
```
