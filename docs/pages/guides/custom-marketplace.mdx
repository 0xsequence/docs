---
title: Creating a Custom Marketplace with Sequence Market Protocol and Embedded Wallet Integration
...
1. [Minting](/guides/custom-marketplace#minting): Minting of tokens to your wallet from the Sequence Builder
2. [Wallet Authentication](/guides/custom-marketplace#blockchain-queries): Use of Sequence Kit to authenticate a user
3. [Blockchain Queries](/guides/custom-marketplace#blockchain-queries): Querying of token balances using the Indexer
...
7. [(Optional) Enable Embedded Wallet](/guides/custom-marketplace#7-optional-enable-embedded-wallet): Add a more seamless UX experience with no-confirmation transactions
...
Your choice from the Sequence stack is to use either an [Embedded Wallet](/solutions/wallets/embedded-wallet/overview) for headless and web2-like UX, or a [Universal Wallet](/solutions/wallets/universal-wallet/overview) with [Sequence Kit](/solutions/wallets/sequence-kit/overview) to reach more types of wallets.
