---
title: Building a Gasless Serverless Transactions API with Cloudflare and Sequence
...
3. [Use EthAuthProof to Prevent EOA DDoS](/guides/mint-collectibles-serverless#use-ethauthproof-to-prevent-eoa-ddos)
...
![ETHAuthProof Viewer](/img/relayer/ethauthproof_viewer_connect.png)

Press the `connect` button and then `copy to clipboard`.

![ETHAuthProof Viewer copy to clipboard](/img/relayer/ethauthproof_viewer_copy.png)
