...
1. [Access Key Management](/guides/analytics-guide#1-access-key-management): Claim a secret access key to interact with the Sequence stack
2. [Cloudflare Worker](/guides/analytics-guide#2-cloudflare-worker): Create a function that queries the Sequence stack and produces project specific data points
3. [Dune Dashboard](/guides/analytics-guide#3-dune-dashboard): Create a view into the data as a shareable dashboard
...
Included in the Sequence Analytics API is the days with zero activity removed from the response. However, if you want to include this in your Dune queries to showcase the spacing of time in relation of data, you can use the following function to complete the days not showing data in the correct date format:
...
![dune create query](/img/guides/analytics/dune_create_query.png)
...
![add visualization](/img/guides/analytics/dune_add_visualization.png)

Finally, click `Save` and add a name to your query.

![save query](/img/guides/analytics/dune_query_save.png)
...
![dune create dashboard](/img/guides/analytics/dune_create_dashboard.png)

Once created add the previous 2 queries by selecting `Edit` and `Add visualization`.

![dune edit dashboard](/img/guides/analytics/dune_edit_dashboard.png)

![dune add visualization from dashboard](/img/guides/analytics/dune_add_visualization_from_dashboard.png)
...
![dune share dashboard](/img/guides/analytics/dune_share_dashboard.png)