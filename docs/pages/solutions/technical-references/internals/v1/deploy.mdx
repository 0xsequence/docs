---
title: Deploy Process V1 for Sequence Wallet Context on New Network
...
The following steps are required to deploy the [Sequence Wallet V1 Context](/solutions/technical-references/internals/v1/deploy) on a new network.
...
Compile and deploy the contracts in the [Sequence Wallet Context](/solutions/technical-references/internals/v1/deploy) using the UniversalDeployer2.
