...
Additionally, our quickstart page for the [Marketplace APIs](/solutions/marketplaces/orderbook/quickstart) has a variety of templates, demos, and common integration patterns needed to get you started. We also provide a step by step guide of leveraging the APIs for [building a custom marketplace](/guides/custom-marketplace).
