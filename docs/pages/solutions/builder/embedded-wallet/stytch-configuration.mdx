...
![Obtain a Project ID](/img/builder/stytch_obtain_keys.png)

## Update the Redirect URL

For local development use `http://localhost:4444/authenticate`

![Obtain a Project ID](/img/builder/stytch_create_new_redirect_uri.png)
...
You can enable Stytch Wallets by directing yourself to [the Early Access Page](https://sequence.build/earlyaccess) and enable it via the toggle.
...
Once configured, implement a Sequence boilerplate using the Sequence CLI by inputting the command in your terminal and following the prompts to input the `Project Access Key`, `WaaS Config Key`, and `Stytch Public Token`, or, use select the prompt for the test keys:
