...
- [**Get Wallet Address**](/solutions/wallets/embedded-wallet/examples/use-wallets#wallet-access): Access the wallet linked to the user's authenticated account. This wallet serves as the gateway to all account functions.
- [**Sign Messages**](/solutions/wallets/embedded-wallet/examples/use-wallets#sign-messages): Signing a message using the embedded wallet.
