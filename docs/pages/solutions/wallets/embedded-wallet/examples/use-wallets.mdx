...
```
<Callout type="danger">
Assets stored in the guest wallet after a browser cache has been cleared - or if the user has uninstalled the app - will not be accessible by the user. We generally recommend after any value has been transferred or is available for the user to claim, that you prompt the user to sign in with a social provider to ensure asset continuity.
</Callout>
