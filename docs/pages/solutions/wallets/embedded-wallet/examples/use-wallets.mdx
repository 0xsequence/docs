...
The Embedded Wallet can be initialized using a Social Authentication `OAuth` token (or PlayFab `ticket`) for web2 authentication and web3 features or as a `Guest Wallet` which is ephemeral.
