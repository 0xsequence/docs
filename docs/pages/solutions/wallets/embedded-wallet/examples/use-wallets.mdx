...
<Callout type="info">
You can view an example project for implementing this flow with web2 authentication [here](https://github.com/0xsequence/kit-embedded-wallet-react-boilerplate.git)
</Callout>
