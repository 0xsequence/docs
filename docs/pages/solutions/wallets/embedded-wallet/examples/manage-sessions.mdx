...
<Callout type="info">
For an example boilerplate for implementing an Email Authentication Embedded Wallet example, see this [application](https://email-waas-boilerplate.pages.dev/) and [example code here.](https://github.com/0xsequence-demos/email-waas-react-boilerplate)
</Callout>
