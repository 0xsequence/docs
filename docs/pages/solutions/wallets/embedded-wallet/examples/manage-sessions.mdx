...
Sequence supports a variety of authentication methods:

- [Email](/solutions/wallets/embedded-wallet/examples/manage-sessions#email-sign-in--sign-up)
- [Google / Apple](/solutions/wallets/embedded-wallet/examples/manage-sessions#google--apple-auth)
- [Microsoft PlayFab](/solutions/wallets/embedded-wallet/examples/manage-sessions#microsoft-playfab-auth)

### Email Sign In / Sign Up

The Embedded Wallet SDK can enable developers to accept any @domain email and initiate an Embedded Wallet session based on the successful answer of a One-Time Password. The feature enables:
...
```sh
npm create vite @0xsequence/waas @react-oauth/google
# or
pnpm create vite @0xsequence/waas @react-oauth/google
# or
yarn create vite @0xsequence/waas @react-oauth/google
```
...
##### PlayFab without Google

<Callout type="info">
If you don't want to use Google for your users, you can use a custom username / password schema, or, even use ENS as a method to generate a unique identifier passed to the PlayFab SDK:
