...
Triggered upon successful execution of a [send transaction intent](/solutions/wallets/embedded-wallet/implementation-details/action-payloads#send-transaction-payload). The code for this response is `transactionReceipt`.
...
| request        | [SendTransactionPayload](https://docs.sequence.xyz/solutions/wallets/embedded-wallet/implementation-details/action-payloads#send-transaction-payload)| The original request packet of the transaction       | No       |
...
Triggered upon failed to execute a [send transaction intent](/solutions/wallets/embedded-wallet/implementation-details/action-payloads#send-transaction-payload). The code for this response is `transactionFailed`.
...
| request             | [SendTransactionPayload](https://docs.sequence.xyz//solutions/embedded-wallet/implementation-details/response-payloads/#send-transaction-payload)      | The packet of transactions that were attempted.              |
...
Triggered after a successful [sign message intent](/solutions/wallets/embedded-wallet/implementation-details/action-payloads#sign-message-payload). The code is `signedMessage`.
...
Occurs after successfully executing an [open session intent](/solutions/wallets/embedded-wallet/implementation-details/action-payloads#open-session-payload). The code is `sessionOpened`.
