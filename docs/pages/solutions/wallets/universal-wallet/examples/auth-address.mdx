---
title: Title: Seamless User Authentication with Sequence Wallet Addresses
description: Learn how to authenticate users using Sequence by requesting their wallet address and verifying it through message signature.
---
