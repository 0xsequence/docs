---
title: Sequence - Web3 Gaming Platform - Universal Wallet Sign Message
description: Documentation for Universal Wallet Message Signing for the Sequence infrastructure stack for web3 gaming.
---
