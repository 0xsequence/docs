---
title: Title: Efficient ERC-1155 Collectible Token Transfers with Batching
description: This code snippet demonstrates how to send ERC-1155 collectible tokens using ethers.js. It showcases the process of encoding the transfer, creating transactions, and sending them individually or in a batch.
---
