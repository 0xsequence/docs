---
title: Batch Sending ERC-721 (NFT) Tokens with ethers.js
description: The process of sending ERC-721 (NFT) tokens involves encoding the transfer function with specific parameters like sender, recipient, and token ID.
---
