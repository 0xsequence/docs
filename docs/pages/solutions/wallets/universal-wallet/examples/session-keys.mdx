---
title: Sequence - Web3 Gaming Platform - Universal Wallet Session Keys
description: Documentation for Universal Wallet Session Keys for the Sequence infrastructure stack for web3 gaming.
---
