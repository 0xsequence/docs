---
title: Sequence - Web3 Gaming Platform - Universal Wallet Batch Transactions
description: Documentation for Universal Wallet Batch Transactions for the Sequence infrastructure stack for web3 gaming.
---
