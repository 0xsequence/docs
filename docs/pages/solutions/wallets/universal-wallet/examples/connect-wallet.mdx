---
title: Sequence - Web3 Gaming Platform - Universal Wallet Connect Wallet
description: Documentation for Universal Wallet Connect Wallet for the Sequence infrastructure stack for web3 gaming.
---
