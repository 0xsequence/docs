...
Sequence offers multiple wallet options to integrate into your products. We have two main options: the [Embedded Wallet](/solutions/wallets/embedded-wallet/overview) and the Universal Wallet. Both are completely non-custodial.
