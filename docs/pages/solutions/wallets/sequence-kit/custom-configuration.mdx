...
<div>
  <img
    src="/img/kit/sign-in-modal-with-logo.png"
    alt="Enable a dark theme to Sequence Kit"
  />
</div>
...
<div>
  <img
    src="/img/kit/sign-in-modal-project-name.png"
    alt="Add a project name to Sequence Kit"
  />
</div>
