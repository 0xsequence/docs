...
```bash
npm install @0xsequence/kit wagmi ethers viem 0xsequence @tanstack/react-query
# or
pnpm install @0xsequence/kit wagmi ethers viem 0xsequence @tanstack/react-query
# or
yarn add @0xsequence/kit wagmi ethers viem 0xsequence @tanstack/react-query
```
