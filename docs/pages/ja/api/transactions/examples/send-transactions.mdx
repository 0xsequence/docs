---
title: MOCKDATA + ja-translated Sequence - API Send Transaction
description: ja-translated Documentation for the Transactions API for sending transactions in Typescript or go
---
