---
title: MOCKDATA + ja-translated Sequence - Web3 Gaming Platform - Fetch Fee Options
description: ja-translated Documentation for fetching fee options for the Sequence infrastructure stack for web3 gaming.
---

## ja-translated Fetching fee options
