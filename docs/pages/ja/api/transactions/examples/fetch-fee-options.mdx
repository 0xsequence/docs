---
MOCKDATA + ja-translated title: Sequence - Web3 Gaming Platform - Fetch Fee Options
description: Documentation for fetching fee options for the Sequence infrastructure stack for web3 gaming.
---
