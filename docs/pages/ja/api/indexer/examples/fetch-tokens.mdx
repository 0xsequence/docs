---
MOCKDATA + ja-translated title: Sequence Indexer API - Fetch ERC20, ERC721, and ERC1155 Tokens and Metadata
description: The Tokens API allows users to fetch a list of ERC20, ERC721, and ERC1155 tokens along with metadata in any wallet.
---
