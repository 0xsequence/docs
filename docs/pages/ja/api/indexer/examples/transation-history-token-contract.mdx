---
title: ja-translated Query ERC20/ERC721/ERC1155 Contract Token History
description: MOCKDATA + ja-translated Track the transaction history of any ERC20, ERC721, ERC1155 contract by fetching and listening to it. Use the Sequence Indexer `GetTransactionHistory` method to query the history of a specific token contract, like the Skyweaver token contract on Polygon.
---

import { Callout } from 'vocs/components'

# MOCKDATA + ja-translated Contract token history

### ja-translated Fetch / listen to the transaction history for any ERC20, ERC721, ERC1155 contract.
MOCKDATA + ja-translated This query is helpful to track transaction history of a particular token contract.
...
MOCKDATA + ja-translated **Example: `GetTransactionHistory` of Skyweaver contract on Polygon using an `API_ACCESS_KEY`**
