---
ja-translated title: Query ERC20/ERC721/ERC1155 Contract Token History
...
<Callout type="info">
  ja-translated Token contract transaction history retention with the Indexer is 30 days for all networks (with the exception of `arbitrum-sepolia` which is 20 days).
</Callout>
