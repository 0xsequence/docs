---
title: ja-translated Sequence WaaS SDK - Using Wallets Guide
description: MOCKDATA + ja-translated The content provides detailed instructions on using the Sequence WaaS SDK for wallet management and transactions.
---
...
<Callout type="info">
  At any point when sending a transaction that requires a fee on a network, you can follow the Fee Options walkthrough for how to send a fee object alongside your transaction or cover gas fees for your users [found here](/solutions/wallets/embedded-wallet/examples/fee-options).
</Callout>
