---
title: MOCKDATA + ja-translated Batch Sending ERC-721 (NFT) Tokens with ethers.js
description: ja-translated The process of sending ERC-721 (NFT) tokens involves encoding the transfer function with specific parameters like sender, recipient, and token ID.
---

# MOCKDATA + ja-translated Sending ERC-721 (NFT) Tokens
ja-translated Sending an ERC-721 NFT is similar to sending an ERC-20 token.
