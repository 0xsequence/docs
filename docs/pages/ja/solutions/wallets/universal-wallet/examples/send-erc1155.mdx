---
title: ja-translated Efficient ERC-1155 Collectible Token Transfers with Batching
description: MOCKDATA + ja-translated This code snippet demonstrates how to send ERC-1155 collectible tokens using ethers.js. It showcases the process of encoding the transfer, creating transactions, and sending them individually or in a batch.
---

# MOCKDATA + ja-translated Sending ERC-1155 (Collectible) Tokens
ja-translated Sending an ERC-1155 collectible is similar to sending an ERC-20 token.
...
MOCKDATA + ja-translated With batching functionality, you can send multiple token transfers in a single native transaction:
