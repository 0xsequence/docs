---
title: ja-translated Sequence - Web3 Gaming Platform - Universal Wallet Sign Message
description: MOCKDATA + ja-translated Documentation for Universal Wallet Message Signing for the Sequence infrastructure stack for web3 gaming.
---
...
<Callout type="danger">
  INTRODUCING THE SEQUENCE BUILDER - [https://sequence.build](https://sequence.build)
