---
title: ja-translated Sequence - Web3 Gaming Platform - Universal Wallet Batch Transactions
description: MOCKDATA + ja-translated Documentation for Universal Wallet Batch Transactions for the Sequence infrastructure stack for web3 gaming.
---

# ja-translated Sending a Batch of Transactions
MOCKDATA + ja-translated Likewise, bundling multiple transactions to be sent in a single native transaction is equally as easy:
...
MOCKDATA + ja-translated The transactions don't have to be the same token or even token standard either.
