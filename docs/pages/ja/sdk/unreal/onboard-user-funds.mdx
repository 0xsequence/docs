...
ja-translated From here, you can open the OnRampLink using `FPlatformProcess::LaunchURL`. Alternatively, you can use:
...
MOCKDATA + ja-translated To check the countries supported by Transak and learn about how they are supported, use the `GetSupportedCountries` method.
...
## ja-translated Using Transak from USequenceWallet
MOCKDATA + ja-translated You can also access the Transak functionalities straight from `USequenceWallet`:
