...
# ja-translated Bootstrap your Game
MOCKDATA + ja-translated Sequence's Unreal SDK includes a range of features to help you bootstrap your game.
...
## ja-translated Inventory
MOCKDATA + ja-translated Create the `Sequence Inventory` widget to display a QR code to receive funds or send funds to other wallets.
...
## ja-translated Primary Sale
MOCKDATA + ja-translated Create the `Sequence Primary Sale` widget to display a QR code to receive funds or send funds to other wallets.
...
## ja-translated My Wallet View
MOCKDATA + ja-translated Create the `Sequence Profile` widget to display a QR code to receive funds or send funds to other wallets.
