---
MOCKDATA + ja-translated title: Sequence - Web3 Gaming Platform - Unreal SDK Sequence API
  ...
  items={[
    {
      ...
      value:
        "The type of chain you want to request information from. This includes options like Ethereum Mainnet or Sepolia. " +
  ...
  items={[
    {
      ...
      value:
        "Contains a SeqTokenBalance array that lists all token IDs owned by the specified wallet address. " +
  ...
  items={[
    {
      ...
      value:
        "Contains a SeqTokenSupply array that lists all token IDs available on the specified contract address. " +
  ...
  items={[
    {
      ...
      value:
        "Contains a SeqTokenSupply array for each specified ID in the 'Token Map'. " +
        "Each element contains a 'supply' value. If 'Include Metadata' is set to true, token metadata is also included.",
    },
  ]}
/>
