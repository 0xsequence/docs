---
title: ja-translated Batch Sending Multiple Transactions with Different Token Standards
description: MOCKDATA + ja-translated How to bundle multiple transactions in a single native transaction.
---
