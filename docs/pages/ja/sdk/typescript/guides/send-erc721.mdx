---
title: ja-translated Sequence - Web3 Gaming Platform - Typescript send ERC721s
description: MOCKDATA + ja-translated Documentation for Typescript Send ERC721s with the Sequence infrastructure stack for web3 gaming.
---
