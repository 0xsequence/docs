...
Ready to integrate Sequence Kit into your application? Check out our [Getting Started guide](/solutions/wallets/sequence-kit/getting-started). If you're already familiar with Sequence Kit dive into the available [configuration options](/solutions/wallets/sequence-kit/configuration) or take a look at the [checkout](/solutions/wallets/sequence-kit/checkout).