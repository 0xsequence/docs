...
FallbackEncryptionKey = "Create a 32-character long alphanumeric encryption key."
...
:::tip
Only alphanumeric characters are accepted for your **encryption key**. You can use a password manager (or any other secure randomness source) to generate this encryption key
:::
