...
## Build-in GUI Integration

If you are using the built-in GUI, authentication should work automatically. You can skip this page; unless, of course, you're curious to learn more about how it works.
