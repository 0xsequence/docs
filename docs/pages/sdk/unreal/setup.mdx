---
title: Sequence - Web3 Gaming Platform - Unreal SDK Setup
description: Documentation for Unreal SDK setup for the Sequence infrastructure stack for web3 gaming when setting up the configuration for the Unreal Engine SDK.
---
