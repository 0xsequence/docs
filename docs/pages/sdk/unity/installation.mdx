---
title: Installing Sequence Unity SDK - Package Manager vs. Manual Installation
description: To install the Sequence Unity SDK, the recommended method is using OpenUPM or Package Manager UI.
---
