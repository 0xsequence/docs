...
1. [Email + OTP Sign In](/sdk/unity/authentication/email)

2. [OIDC-based Social Sign In](/sdk/unity/authentication/oidc)

The SDK also provides support for:

3. [PlayFab Sign In](/sdk/unity/authentication/playfab)

4. [Guest Sign In](/sdk/unity/authentication/guest)
