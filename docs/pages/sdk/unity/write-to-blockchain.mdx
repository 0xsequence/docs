---
title: Blockchain Transaction Writing with WaaS - A Comprehensive Guide
...
You can then validate this payload on your server and mint the token to the user's address. For an example implementation and setup, please see [this part of our Jelly Forest guide](/guide/jelly-forest-unity-guide#4-deploy-a-remote-minter).
