...
* [Token metadata API & standards](/api/metadata/examples/token-metadata)
* [Contract-level metadata API & standards](/api/metadata/examples/contract-metadata)
* [Alternative, REST API Usage](/api/metadata/examples/rest-api)
