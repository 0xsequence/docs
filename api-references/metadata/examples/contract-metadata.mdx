...
* [Learn how to query contract-level metadata directly for any contract](/api/metadata/examples/token-metadata#fetch-token-metadata-for-any-erc721-or-erc1155-contract)
* [Learn about contract-level metadata for ERC20, ERC721 and ERC1155 tokens](/api/metadata/examples/token-metadata#token-metadata-standards)
* [Learn about querying contract-level info metadata extensions for ERC20, ERC721 and ERC1155 tokens](/api/metadata/examples/contract-metadata#search-contract-metadata)
