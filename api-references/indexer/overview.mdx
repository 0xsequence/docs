...
The Sequence Indexer is a backend web3 service that makes it easy to query real-time blockchain state such as token balances, history, supplies and NFT metadata. The Indexer automatically indexes every ERC20, ERC721 and ERC1155 token from Ethereum-compatible chains.

The Sequence Indexer is a powerful tool that can be used to build wallets, apps, and games that
...
of infrastructure, and you may use it directly from your app, game, or even from
a server.
