...
Get- and remove linked wallets in your Unreal project. Learn more on [how to link external wallets](/solutions_old/wallets/embedded-wallet/link-wallets/integration-guide) such as Metamask on a web app.
