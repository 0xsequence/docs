...
Leverage our [account federation feature](/sdk/unreal/embedded-wallet/authentication#account-federation) to link the wallet to another email or social account to keep access.
