...
Leverage our [account federation feature](/sdk/unreal/embedded-wallet/onboarding/authentication#account-federation) to link the wallet to another email or social account to keep access.
...
Sign In with a valid Google Id Token. You get this from the [Get Google Id Token](/sdk/unreal/embedded-wallet/onboarding/authentication#get-google-id-token) node.
...
Sign In with a valid Apple Id Token. You get this from the [Get Apple Id Token](/sdk/unreal/embedded-wallet/onboarding/authentication#get-apple-id-token) node.
...
The SDK will check if [there's an existing session stored](/sdk/unreal/embedded-wallet/onboarding/manage_sessions#check-existing-session) and will
