...
<Steps>
  ...
  <Step title="Integrate Login">
    ...
    to our login methods. Checkout the [authentication](/sdk/unreal/embedded-wallet/onboarding/authentication#requirements) section on how to
    configure each login method.

    Learn how to manually [integrate login methods](/sdk/unreal/embedded-wallet/onboarding/authentication) such as Google, Apple, or PlayFab.
