...
<Steps>
    ...
    <Step title={"Create your own Sign-In flow"}>
        You can optionally call [Get Ecosystem Config](/sdk/unreal/wallets/ecosystem-wallet/authentication#get-ecosystem-config)
...
<Warning>
    If you used v1 or v2 of the Unreal SDK: `SequenceWallet` classes now refer to the Ecosystem Wallet.
    Use `SequenceEmbeddedWallet` instead, if you want to continue with your Embedded Wallet integration.
</Warning>
