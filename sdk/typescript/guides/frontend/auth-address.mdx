...
while the user is prompt to connect their wallet to your app. This allows the user experience to be simpler and
more seamless.
...
The above example demonstrates how to connect and verify the user's identity in your app on the client-side,
