...
The Sequence Unity Embedded Wallet SDK provides full Sequence [Embedded Wallet](/sdk/headless-wallet) and [Indexer](/sdk/api-references/indexer) integration for your Unity Games, integrated with our own purpose-built for Unity SequenceEthereum library. That's right, no Nethereum required!
