...
<Note>
The chainId is expected to be in hexadecimal format. If you are working with a `Chain` object (recommended), you can use the `AsString` method to get the hexadecimal format of the chain id
</Note>
