---
title: Sidekick Unity Integration
description: How to set up and use Sequence Sidekick inside Unity
---

# Sequence Sidekick Unity Integration

Sequence Sidekick enables seamless interaction with blockchain functionality directly within the Unity Editor — no need to run the game or leave the Unity environment.It allows you to develop and test blockchain features with wallets, contracts, and more — all from within Unity.

For advanced usage and API details, check the full [Sequence Sidekick documentation](https://docs.sequence.xyz/solutions/sidekick/overview).
...
- In the Inspector, set the path to your local Sidekick executable.
...
- Drag the `SidekickEditorController` prefab into any scene.
- This prefab enables communication between Unity and the Sidekick backend.
