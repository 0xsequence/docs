...
<Warning>Before proceeding, please make sure you have properly configured the Embedded Wallet in the Builder. See this [guide](/solutions/builder/embedded-wallet).</Warning>

<Warning>Please double check that you have copy and pasted the configuration keys from the Builder correctly! This is the most common issue reported when integrating our SDK. If you receive an "invalid tenant" response, you have messed up your configuration! See this [guide](/solutions/builder/embedded-wallet).</Warning>