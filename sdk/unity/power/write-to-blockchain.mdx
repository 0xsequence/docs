---
title: Unity Write to Blockchain — Sequence Docs
...
<Info>Transaction sponsoring is only available for Developer tier and above. For more information on gas sponsoring, please see [this document](/solutions/builder/gas-sponsorship). For more information on upgrading your project billing tier, please see [this guide](/solutions/builder/project-settings#update-your-project-subscription-plan).</Info>
