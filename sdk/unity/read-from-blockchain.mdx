...
description: To read data from the blockchain, use the Unity-Native implementation of the Sequence Indexer. Create a ChainIndexer instance to access all functionalities of the IIndexer interface.
---



Reading from the blockchain is done using Unity-Native implementation of our [Sequence Indexer](/api-references-references/indexer/overview).
