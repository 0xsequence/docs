...
The Sequence Embedded Wallet SDK can be used with React Native for complete Sequence [Embedded Wallet](/solutions_old/wallets/embedded-wallet/overview) and [Indexer](/api-references/indexer/overview) integration.
