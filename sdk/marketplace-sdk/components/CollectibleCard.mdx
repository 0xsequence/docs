...
interface MarketCardSpecificProps {
  ...
  onOfferClick?: (params: { order?: Order; e: React.MouseEvent<HTMLButtonElement> }) => void;
  balance?: string;
...
```tsx
import { CollectibleCard, useListMarketCardData } from "@0xsequence/marketplace-sdk/react";
