...
- **Sponsored Contract or Wallet**: Having the smart contract or wallet sponsored, not requiring a fee option inputted into the SDK call. You can learn about sponsoring a contract or wallet [here](/sdk/gas-tank).
...
You can either transfer tokens to your wallet, or, use the [on-ramp feature](/sdk/web/on-ramp) using the Sequence Kit solution.
