...
To view the full response object, see the [Response payloads](/sdk/api/response-payloads) section.
...
To view the full response object, see the wallet [Response payloads](/sdk/api/response-payloads) section.
