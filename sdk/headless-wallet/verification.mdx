...
title: "Headless Wallet Verification"
...
<Note>
  If you're not using the Embedded Wallet with TypeScript but instead working with the Web SDK, you can go [here](/sdk/web/wallet-sdk/embedded/guides/verification) to see how to handle the verification process.
</Note>
