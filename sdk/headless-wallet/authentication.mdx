...
- `WaaSConfigKey`: This key can be learned about [here](/solutions/builder/embedded-wallet/index)
- `ProjectAccessKey`: This key can be learned about [here](/solutions/builder/embedded-wallet/index)
