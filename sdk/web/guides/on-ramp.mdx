...
description: The checkout on-ramp modal in Sequence Checkout allows developers to easily onboard users with fiat currency into cryptocurrency using a credit card.
...
<Step title="Setup Sequence Connect">
...
Congratulations! You’ve just learned how to add funds to your wallet using Sequence Connect and Sequence Checkout.
