...
title: "Smart Swaps"
description: Sequence Smart Swaps leveraging currencies in player wallets to another currency on the same chain. Developers can define the target currency and Sequence will handle everything, including the UI and flow through Sequence Connect and Sequence Checkout.
...
To integrate the Swap feature with Sequence Connect, follow these steps:
...
Congratulations! You’ve just learned how to use smart swaps with Sequence Connect and Sequence Checkout.
