...
<Step title="On ramp to a supported token">
  Complete the [On-ramp](/sdk/web/examples/on-ramp) example
</Step>
...
```tsx
  import { useState } from 'react'
  import { SwapModalSettings, useAddFundsModal, useSwapModal } from '@0xsequence/kit-checkout'
  import { useAccount } from 'wagmi'
...
Congratulations! You’ve just learned how to on-ramp and swap to a custom token using Sequence Kit.
