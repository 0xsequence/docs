...
Whether external wallets are hidden in the Connect Modal.

#### hideConnectedWallets

`boolean | undefined`

Whether connected wallets are hidden in the Connect Modal.

#### hideSocialConnectOptions

`boolean | undefined`

Whether social wallets (email/social logins) are hidden in the Connect Modal.
