...
The `walletUrl` is the URL of the Ecosystem Wallet your dApp will use, for our demo, we are using the Sequence Ecosystem Wallet [https://v3.sequence.app](https://v3.sequence.app).
...
The configuration we created in [step 2](/sdk/web/wallet-sdk/ecosystem/getting-started#create-a-config) needs to be passed into the `SequenceConnect config`
