...
- **Embedded Wallets**: Leverage our non-custodial embedded wallet within Sequence Connect to put web3 in the background such as optional popups / modals so users can focus on the experience.
...
- **Customizability**: Brand Sequence Connect with your own logo, color scheme and configure it with your social providers and wallets you want to service.

Explore the potential of our Web SDK's by trying out our [demo](https://0xsequence.github.io/web-sdk/)!

## Next Steps

Ready to integrate WEB SDK into your application? Check out our [Quickstart guide](/sdk/web/getting-started). If you're already familiar with Sequence Connect dive into the available [configuration options](/sdk/web/custom-configuration) or take a look at the [checkout](/sdk/web/guides/checkout).