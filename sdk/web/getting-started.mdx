...
# or
pnpm install @0xsequence/connect @0xsequence/react-hooks wagmi ethers@6.13.0 viem 0xsequence @tanstack/react-query
# or
yarn add @0xsequence/connect @0xsequence/react-hooks wagmi ethers@6.13.0 viem 0xsequence @tanstack/react-query
```
