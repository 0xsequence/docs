...
<CardGroup>
  ...
  <Card title="Marketplace APIs (Aggregated Listings)" href="/api/marketplace">
...
- **You already have an app and only need marketplace actions** (e.g., list/buy in your existing UI) → use the <a href="/sdk/web/marketplace">Marketplace SDK</a>.
- **You need search/browse at scale with external liquidity** → use the <a href="/api/marketplace">Marketplace APIs (Aggregated Listings)</a>.
...
- <strong>Shop</strong> (primary sales): <a href="/solutions/shop/overview">/solutions/shop/overview</a>  
- <strong>Trails</strong> (any-token orchestration): <a href="/solutions/payments/trails">/solutions/payments/trails</a>  
- <strong>Checkout SDK</strong> (card payments for NFTs): <a href="/solutions/payments/checkout">/solutions/payments/checkout</a>
