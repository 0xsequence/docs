...
- **You already have an app and only need marketplace actions** (e.g., list/buy in your existing UI) → use the <a href="/sdk/web/marketplace-sdk/overview">Marketplace SDK</a>.
