...
### Getting started
<CardGroup cols={2}>
  <Card title="Starter Boilerplate" icon="play" href="/solutions/payments/marketplace/custom">
...
<CardGroup cols={2}>
  ...
  <Card title="Cross Platform" icon="mobile" href="/solutions/payments/overview#sequence-marketplaces">
