...
- You’ve completed the [Marketplace configuration flow](/solutions/payments/marketplace/hosted) (Marketplace Settings, Page Settings, Wallet Settings)
...
If you already have a Collectible, skip to the next step. Otherwise, complete [this guide to create a collectible](/solutions/builder/contracts/deploy-an-item-collection) and [add a collection to your collectible](/solutions/builder/collections) to include it in your shop. 
...
Select wallet type [Sequence Embedded Wallet](/solutions/wallets/developers/embedded-wallet/overview).
