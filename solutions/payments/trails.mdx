...
- **Use with Sequence:** launch Trails from your dapp UI alongside <a href="/sdk/web/overview">Web SDK</a>, or combine with <a href="/solutions/payments/checkout">Checkout SDK</a> for card paths.
