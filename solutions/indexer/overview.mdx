...
<CardGroup>
  ...
  <Card title="Event Subscriptions" href="/solutions/indexer/event-subscriptions">
    Subscribe to events for any wallet or contract address.
  </Card>
...
- [Subscribe to events for any wallet or contract address](/solutions/indexer/event-subscriptions)
