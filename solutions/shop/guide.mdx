...
description: Follow this 10-step guide to learn how to use the Sequence Builder which offers game builders a Shop that can be easily customized and integrated into their game experience without any coding experience needed.
sidebarTitle: Guide
---
...
Follow this 10-step guide to customize and launch a Shop in minutes with a set of EVM based collectibles.
...
If you already have a Collectible, skip to the next step, or, complete [the following guide to create a collectible](/solutions/collectibles/contracts/deploy-an-item-collection) and [add a collection to your collectible](/solutions/builder/collections) to include on your shop. 

</Step>

<Step title="Deploy Shop">

After accessing your project, and the `Marketplace` nav tab, select `Activate your Shop` button

<Frame>
![deploy new shop](/images/shop/builder_deploy_new_shop.png)
</Frame>

Once the Shop is enabled, you can begin listing items for sale using one of the supported Sequence sale contracts.
...
2. **Upload a banner image** for the sale listing. (Recommended size: **2440 x 960 pixels**)
...
<Frame>
![add sale](/images/shop/builder_create_new_sale_erc1155_shop.png)
</Frame>

1. **Configure sale settings**, including:
    - Total supply (Total number of NFTs that can be minted)
    - Start and end time
    - Pricing details
...
Edit and update the banner image that is located in the top of shop, reaching horizontally across the shop page.
...
At this point, your Shop will be live, and anyone with the link can access and purchase your listed items.

</Step>

<Step title="Launch Shop">

Once you're finished, launch your shop and share with your friends and community!
<Frame>
![launch shop](/images/shop/builder_shop_update_settings.png)
</Frame>
</Step>
</Steps>
