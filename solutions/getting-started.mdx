...
<CardGroup cols={3}>
  <Card
    title="Onboard and authenticate your users"
    icon="sack-dollar"
    href="/solutions/wallets/embedded-wallet/quickstart"
  >
  Authenticate your users with email, social and more with native account abstraction wallets for the best experiencce possible.
  </Card>
  <Card
