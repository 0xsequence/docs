...
Follow this [guide](/solutions/builder/contracts/deploy-an-item-collection) in order to deploy a collectible contract as well as upload the collection metadata that you wish to create a sale for.
<Frame> 
