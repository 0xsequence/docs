...
This property alongside the use of [NanoUniversalDeployer](/solutions/technical-references/architecture/v1/deploy#1-deploy-nanouniversaldeployer) or [UniversalDeployer](/solutions/technical-references/architecture/v1/deploy#2-deploy-universaldeployer2) is the reason why Sequence wallets can obtain the same address on multiple chains.
