...
The following steps are required to deploy the [Sequence Wallet Context](/solutions/technical-references/architecture/v1/wallet-context) on a new network.
...
Deploy each of the contracts in the [Sequence Wallet Context](/solutions/technical-references/architecture/v1/wallet-context) using the Singleton Factory.
