...
sidebarTitle: Contract Deployments
---
...
- v1: [Deploy v1 Contracts](/solutions/technical-references/architecture/v1/deploy)
- v2: [Deploy v2 Contracts](/solutions/technical-references/architecture/v2/deploy)