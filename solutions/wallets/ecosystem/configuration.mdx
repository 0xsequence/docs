...
To enable your ecosystem partners, simply share your Embedded Wallet keys (WaaS and Project Access Key) with your trusted partners as well as the design for Sequence Kit. All they have to do is integrate [Sequence Kit](/sdk/web/getting-started) into their application with the provided keys.
</Step>
</Steps>
