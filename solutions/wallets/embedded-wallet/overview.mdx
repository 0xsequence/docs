...
Sequence Embedded Wallet enables the creation, management and usage of fully functional EVM compatible wallets that can be easily integrated into your game or experience through our various SDKs such as [Web](/solutions/wallets/embedded-wallet/quickstart), [Unity](/sdk/unity/overview) and [Unreal](/sdk/unreal/introduction).
