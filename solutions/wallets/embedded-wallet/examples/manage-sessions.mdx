...
- [Check Valid Session](/solutions/wallets/embedded-wallet/examples/manage-sessions#validation-status): Manage blockchain accounts to sign up or sign in users.
- [Control Session Validation](/solutions/wallets/embedded-wallet/examples/manage-sessions#control-session-validation): Authentication sessions to return important details to be consumed by your application to enhance the experience of games and applications.
- [Close Session](/solutions/wallets/embedded-wallet/examples/manage-sessions#close-session): Manage the listing and dropping of sessions handled by the WaaS stack.
