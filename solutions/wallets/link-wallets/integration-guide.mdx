...
title: "Integrating Wallet Linking"
...
<Steps>
<Step title="Sign Message to Attest to Owning an Address">
...
<Step title="Use API to Add Signature Payload & Parent Wallet Address">
...
<Steps>
<Step title="Sign Message to Attest to Removing a Linked Address">
...
<Step title="Use API to Add Signature Payload for Parent Address">
```typescript
function App(){
    ...
