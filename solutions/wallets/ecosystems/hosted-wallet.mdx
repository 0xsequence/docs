...
<Frame>
![ecosystem wallet](/images/ecosystem/ecosystem-login.opt.jpg)
</Frame>
...
- **Key Machine**: only the latest wallet configuration is accepted on-chain; supports safe key rotation.
