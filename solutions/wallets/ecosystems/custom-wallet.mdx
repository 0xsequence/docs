...
- **[Identity Instrument](/solutions/wallets/ecosystems/identity-instrument)** can be self-hosted in your own AWS Nitro Enclave environment if your compliance model requires it.
- You can run your own **[Sidekick](/solutions/infrastructure/sidekick)** for controlled server-side writes and key custody.
