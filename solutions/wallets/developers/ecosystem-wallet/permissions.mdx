...
description: Configure your dApp to request approve and transfer permissions, eliminating repeated wallet pop-ups for your users.
sidebarTitle: Session Permissions
---
...
Here is a complete example of how to configure your dApp to request approve and transfer permissions, using the Web SDK.
