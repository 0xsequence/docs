...
Dive into the implementation for your own game or application, by following our [integration guide](/solutions/wallets/developers/embedded-wallet/link-wallets/integration-guide).
