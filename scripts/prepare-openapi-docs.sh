...
node libs/openapi_merger.js merge -o docs/pages/api/metadata/metadata.gen.yaml docs/pages/api/metadata/rpc.gen.yaml docs/pages/api/metadata/rpc.gen.yaml
node libs/openapi_merger.js merge -o docs/pages/api/relayer/relayer.gen.yaml docs/pages/api/relayer/rpc.gen.yaml
node libs/openapi_merger.js merge -o docs/pages/api/builder/builder.gen.yaml docs/pages/api/builder/rpc.gen.yaml
...
node libs/example_merger.js merge \
  ...
  docs/pages/api/builder/builder.gen.yaml
