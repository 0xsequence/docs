...
`,e.jsxs(t.p,{children:[e.jsxs(t.a,{href:"https://docs.sequence.xyz/api/metadata/endpoints",children:["Call ",e.jsx(t.code,{children:"CreateCollection"})," endpoint"]})," - ensure you pass in the Secret Service Token created in the prior section."]}),`
`]}),`
`,e.jsxs(t.li,{children:[`
