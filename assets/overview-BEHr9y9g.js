import{d as i,j as e}from"./index-C1I6LFNT.js";const s={title:"Sequence Indexer - Blockchain Token and NFT Data Query Tool",description:"The Sequence Indexer is a web3 service for querying blockchain token and NFT data from Ethereum-compatible networks. It automatically indexes ERC20, ERC721, and ERC1155 tokens, with high reliability and low latency."};function a(t){const n={a:"a",aside:"aside",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"indexer",children:["Indexer",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#indexer",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
